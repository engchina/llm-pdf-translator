...
def translate(
    ...
    selected_service = service_map.get(service, "openai")
        ...
        with gr.Column(scale=1):
            ...
            def env_var_checker(env_var_name: str) -> str:
                if (
                    ...
                    envs_status = (
                        "<span class='env-success'>- {os.environ.get(env_var_name)} - Properly configured.</span><br>"
                    )
                    # if len(value) < 13:
                    #     envs_status += (
            ...
            def on_select_service(value, evt: gr.EventData):
                ...
                if value == "Azure":
                    ...
                    envs_status = env_var_checker("OPENAI_API_KEY") + "\n" + env_var_checker(
                        "OPENAI_BASE_URL") + "\n" + env_var_checker("OPENAI_MODEL_NAME")
                    model_visibility = gr.update(
                        visible=True, value=env_var_checker("OPENAI_MODEL_NAME")
